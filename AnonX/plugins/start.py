...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgEAAxkBAAIFqWR81wuawAQCJdg5xHOHLDXzbl4EAAIiAgACY1pJRQ2ZgKzoflZ1LwQ")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/RANA_societyyyy) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
💖 𝐒ᴇᴀʀᴄʜ 𝐏ᴏᴡᴇʀᴇᴅ 𝐁ʏ {config.MUSIC_BOT_NAME}"""
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• 𝐒ᴜᴩᴩᴏʀᴛ •", url="https://t.me/RANA_societyyyy"
                        ),
                    ],
                ]
            )
        ...
        if config.START_IMG_URL:
            try:
                await message.reply_sticker("CAACAgUAAx0CcD86dQACfgpkmRgWmbm1feDrKJh3KIcIAAHEDVsAApgHAAI4jAABVTjSFPkb2_jeLwQ")
